...
The planner authors and checks these artifacts before feature implementation. See [0002's verification evidence](../docs/0002-formal-verification/0002-formal-verification.md#current-lean-evidence) for the initial models and their limits. Run `pnpm --filter obsidian-agent check:lean` from the repository root inside `devenv shell`.
